...
from pdfminer3.layout import LAParams, LTTextBox #extract text
...
import pafy
import plotly.express as px #for admin
...
def run():
    ...
    activities = ["Normal User","Admin"]   # add ,admin in inverted commas after this
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'kunj' and ad_password == 'kunj123':
